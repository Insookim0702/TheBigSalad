...
!(function (e) {
            ...
            (function e(t, r) {
                for (var a = t.firstChild; a; a = a.nextSibling)
                    3 === a.nodeType
                        ...
                        : 1 === a.nodeType && (n.push({ event: 'start', offset: r, node: a }), (r = e(a, r)), f(a).match(/br|hr|img|input/) || n.push({ event: 'stop', offset: r, node: a }));
                return r;
            })(e, 0),
            n
        );
                              ...
                              for (var r = /\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./, a = 0, n = '', i = 0; i < e.length; i++) {
                                  ...
                                  for (0 < i && (n += t); 0 < c.length; ) {
                                      ...
                                      (n += c.substring(0, o.index)),
                                          ...
                                          '\\' == o[0][0] && o[1] ? (n += '\\' + String(Number(o[1]) + s)) : ((n += o[0]), '(' == o[0] && a++);
                                  }
                              }
                              return n;
                          })(i, '|'),
                    ...
                    : (function () {
                          ...
                          for (a = '', t = 0, b.lR.lastIndex = 0, r = b.lR.exec(m); r; )
                              (a += y(m.substring(t, r.index))),
                                  ...
                                  (e = n.k.hasOwnProperty(s) && n.k[s]) ? ((f += e[1]), (a += o(e[0], y(r[0])))) : (a += y(r[0])),
                                  (t = b.lR.lastIndex),
                                  (r = b.lR.exec(m));
    ...
    function s(e) {
        ...
        g(d) ||
            (v.useBR ? ((t = document.createElementNS('http://www.w3.org/1999/xhtml', 'div')).innerHTML = e.innerHTML.replace(/\n/g, '').replace(/<br[ \/]*>/g, '\n')) : (t = e),
            (i = t.textContent),
            (a = d ? k(d, i, !0) : x(i)),
            (r = _(t)).length &&
            ...
            (e.innerHTML = a.value),
            (e.className =
                ((s = e.className), (c = d), (o = a.language), (l = c ? p[c] : o), (u = [s.trim()]), s.match(/\bhljs\b/) || u.push('hljs'), -1 === s.indexOf(l) && u.push(l), u.join(' ').trim())),
    ...
    return (
        ...
        (n.CSSNM = n.CSS_NUMBER_MODE = { cN: 'number', b: n.NR + '(%|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?', r: 0 }),
        (n.RM = n.REGEXP_MODE = { cN: 'regexp', b: /\//, e: /\/[gimuy]*/, i: /\n/, c: [n.BE, { b: /\[/, e: /\]/, r: 0, c: [n.BE] }] }),
            ...
            return {
                ...
                c: [
                    ...
                    { cN: 'section', b: '</?', e: '>' },
                    {
                        ...
                        b: /\w+/,
                        r: 0,
                        k: { nomarkup: 'order deny arrow setenv rewriterule rewriteengine rewritecond documentroot sethandler errordocument loadmodule options header listen serverroot servername' },
            ...
            return {
                ...
                c: c.concat([
                    ...
                    },
                    {
                        ...
                        c: [
                            { b: i, rB: !0, c: [e.TM], r: 0 },
                            { cN: 'params', b: /\(/, e: /\)/, k: s, r: 0, c: [e.CLCM, e.CBCM, r, a, t, { b: /\(/, e: /\)/, k: s, r: 0, c: ['self', e.CLCM, e.CBCM, r, a, t] }] },
                            e.CLCM,
                            e.CBCM,
                            n,
                        ],
        ...
        n.registerLanguage('cs', function (e) {
            ...
            return {
                ...
                i: /::/,
                c: [
                    e.C('///', '$', { rB: !0, c: [{ cN: 'doctag', v: [{ b: '///', r: 0 }, { b: '\x3c!--|--\x3e' }, { b: '</?', e: '>' }] }] }),
                    e.CLCM,
                    e.CBCM,
                    ...
                    { bK: 'new return throw await else', r: 0 },
                    {
                        ...
                        eE: !0,
                        k: t,
                        c: [{ b: e.IR + '\\s*\\(', rB: !0, c: [e.TM], r: 0 }, { cN: 'params', b: /\(/, e: /\)/, eB: !0, eE: !0, k: t, r: 0, c: [u, r, e.CBCM] }, e.CLCM, e.CBCM],
                    },
                ],
            };
        }),
        ...
        n.registerLanguage('javascript', function (e) {
            ...
            return {
                ...
                c: [
                    ...
                    { cN: 'function', bK: 'function', e: /\{/, eE: !0, c: [e.inherit(e.TM, { b: t }), { cN: 'params', b: /\(/, e: /\)/, eB: !0, eE: !0, c: s }], i: /\[|%/ },
                    { b: /\$[(.]/ },
                    e.METHOD_GUARD,
        ...
        n.registerLanguage('ruby', function (e) {
            ...
            var u = [
                ...
                { cN: 'meta', b: '^([>?]>|[\\w#]+\\(\\w+\\):\\d+:\\d+>|(\\w+-)?\\d+\\.\\d+\\.\\d(p\\d+)?[^>]+>)', starts: { e: '$', c: l } },
            ];
